    ...
    <div id="nav" class="p-2 main-nav">
      <b-navbar toggleable="lg" type="dark" id="navbar">
        <b-navbar-brand :style="{'font-size':'40px'}" class="nav-margin">
          <router-link :to="{ name: 'MovieList' }">바나무비</router-link>
        </b-navbar-brand>
...
<div class="main-nav">
    ...
    <nav class="navbar navbar-expand-lg main-nav">
      <a class="navbar-brand" href="#">바나무비</a>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item active">
            <router-link :to="{ name: 'MovieList' }" class="nav-link">Movies</router-link>
          </li>
          <li class="nav-item">
...
<style>
  ...
  #app {
    font-family: 'Salbo 27px', 'Do Hyeon', Helvetica, Arial, sans-serif;
